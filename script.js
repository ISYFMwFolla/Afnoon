var mainPhrases = ['أهلا يا فُلة', 'الموقع ده معملول علشانك انتي', 'هو مجرد فكرة بسيطة فكرت فيها علشان أفرحك', 'أتمنى تشوفي الذكريات الي محتفظ بيها وبحبها منك استني ثواني'];
var endPhrases = [
